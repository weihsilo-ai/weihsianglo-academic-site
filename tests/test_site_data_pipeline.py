...
class SiteDataPipelineTests(unittest.TestCase):
    ...
    def test_production_index_is_current_and_has_unique_ids(self):
        ...
        self.assertIn('<link rel="stylesheet" href="styles.css?v=20260908-section-labels">', document)
        ...
        self.assertRegex(style_sheet, r"#about \.research-interests-label\s*\{[^}]*font-size:\s*var\(--type-intro\);")
        ...
        self.assertIn('was advised by <span class="mark mark-blue">Dr. Gaojian Huang</span>', document)
